...
const Products = () => {
  return (
    <div
      className="products-section container mx-auto py-10 
     "
    >
      <h2 className="section-title uppercase text-2xl font-bold space-font text-center mb-10">
        Browse all Products
      </h2>
      <div className="products-wrapper grid gap-10 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 ">
        {data.map((product) => (
