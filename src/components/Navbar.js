...
const Navbar = () => {
  return (
    <div className="nav-bg bg-sky-700 text-sky-50 h-20 flex justify-center items-center">
      <div className="navabar container mx-auto flex items-center justify-between">
        <div className="left">
