      ...
      <div className="texts flex flex-col gap-2 px-5 pb-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="uppercase bg-sky-500 text-sky-50 font-medium py-3 px-8 rounded-md hover:bg-orange-500 hover:text-orange-50 duration-300 shadow-lg shadow-sky-300 hover:shadow-orange-300"
          >
            Add to cart
          </button>
        </div>
